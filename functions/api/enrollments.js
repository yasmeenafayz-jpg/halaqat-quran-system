 ...
 *
 * يعتمد فقط على الجداول الموجودة فعليًا في migrations.
 */
...
async function activateEnrollment(
   ...
   *
   * لذلك نعيد استخدام التسجيل القديم
   * إذا كان غير نشط.
   */
  if (existing) {
    if (
