...
async function getReferenceData(db, user) {
  ...
  if (user.role === "teacher") {
    ...
    `;
    studentParams.push(Number(user.teacher_id));
    ...
    `;
    circleParams.push(Number(user.teacher_id));
    ...
    `;
    teacherParams.push(Number(user.student_id));
    ...
    `;
    circleParams.push(Number(user.student_id));
    ...
    `;
    teacherParams.push(Number(user.id));
    ...
    `;
    circleParams.push(Number(user.id));
